...
format: 
    revealjs: 
        ...
        css: [css/logo.css]
        footer: "Sekuentzia Didaktikoak - 2025"
...
Gaurko eskolak hiru atal nagusi izango ditu: **Ekintza komunikatiboa**, lehenengo, bigarrena **testua eta testuen arkitektura** eta hirugarrena **sekuentzia didaktikoak**.

# Ekintza komunikatiboa

## {.center background-color="lightgray"}

[zerbait esatea ezer egitea da]{.gorri}
...
5.  **Egoera**\
    Interaktiboa. Ez-interaktiboa.

6.  **Erabilera-esparrua**\
    Markatu gabeak: informalak, lagunartea, familiartekoa, ezagunen artekoa... Markatuak: formala, lantokikoa, ezezaguna, teknikoa...
...
::: callout-note
## Testuaren arkitekturaren osagarriak

-   Testuaren azpiegitura orokorra
    -   Plan orokorra
    -   Sekuentziak
    -   Interaktibotasuna
-   Testualizazio mekanismoak
    -   Konexioa
    -   Izen-kohesioa
    -   Aditz-kohesioa
-   Ardura enuntziatiboaren mekanismoak
...
##  {.smaller background-color="darkblue"}
